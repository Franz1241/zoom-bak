...
def download_meeting_from_inventory(inv_id, user_email, raw_data, token, config, cursor, conn, version):
    """
...
def download_phone_from_inventory(inv_id, user_email, raw_data, token, config, cursor, conn, version):
    """
...
def download_webinar_from_inventory(inv_id, user_email, raw_data, token, config, cursor, conn, version):
    """
    ...
    try:
        ...
        return save_webinar_metadata(cursor, conn, webinar, user_email, file_info, file_path, None, version)
